---
type: species
scientific_name: "Dendrolagus scottae"
common_name: "Tenkile"
...
protected_breeding_zone: "Papua New Guinea range"
...
- **Protected Breeding Zone:** Papua New Guinea range
- **Ranger Patrol Frequency:** Every 5 days
- **Security Clearance Requirement:** `RESTRICTED`

### Conservation Measures & Protocols
Population trend: Stable. Primary diet: Folivore,,Herbivore. Typical lifestyle: Arboreal, Island endemic, Terrestrial, Territorial,.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-27 21:24 UTC | -11.9285, 10.3076 | `FIELD-CAM-806` | 39.2°C | 79.20% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
