...
- **Protected Breeding Zone:** Amazon Canopy Reserve
- **Ranger Patrol Frequency:** Every 11 days
- **Security Clearance Requirement:** `RESTRICTED`

### Conservation Measures & Protocols
Active tracking program deployed in Amazon Canopy Reserve. Strict anti-poaching measures enforced. Periodic thermal surveillance.
