---
type: species
scientific_name: "Ploceus hypoxanthus"
common_name: "Asian Golden Weaver"
...
protected_breeding_zone: "Cambodia range"
...
- **Protected Breeding Zone:** Cambodia range
- **Ranger Patrol Frequency:** Every 5 days
- **Security Clearance Requirement:** `RESTRICTED`

### Conservation Measures & Protocols
Population trend: Decreasing. Primary diet: Herbivore,,Granivore. Typical lifestyle: Terrestrial, Altricial, Arboreal,.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-31 04:24 UTC | 45.6019, 122.0788 | `FIELD-CAM-708` | 10.1°C | 77.80% | N/A | Simulated field observation within Asia range (no real telemetry source for this dataset). |
