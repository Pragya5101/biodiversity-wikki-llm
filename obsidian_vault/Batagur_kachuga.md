...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 09:24 UTC | 7.7995, 28.3261 | `FIELD-CAM-583` | 0.3°C | 53.30% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
| 2026-08-07 04:24 UTC | -4.4373, 25.8730 | `FIELD-CAM-890` | 26.0°C | 51.10% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
