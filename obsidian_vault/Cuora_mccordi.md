...
common_name: "McCord's box turtle"
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-22 05:24 UTC | -11.2812, 38.4253 | `FIELD-CAM-443` | 36.8°C | 91.50% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
| 2026-07-26 00:24 UTC | -0.7209, 37.2858 | `FIELD-CAM-893` | 1.7°C | 44.00% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
