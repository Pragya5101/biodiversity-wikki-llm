...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-31 11:24 UTC | 17.6969, 22.1404 | `FIELD-CAM-455` | 3.8°C | 46.30% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
| 2026-07-11 17:24 UTC | 17.2458, 10.9866 | `FIELD-CAM-407` | 21.0°C | 64.40% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
