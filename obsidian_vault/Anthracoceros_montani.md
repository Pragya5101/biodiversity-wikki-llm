...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-12 11:24 UTC | 1.1704, 27.2544 | `FIELD-CAM-578` | 4.3°C | 57.80% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
| 2026-08-02 02:24 UTC | 10.7201, 39.1511 | `FIELD-CAM-784` | 17.0°C | 41.90% | N/A | Simulated field observation within unspecified range (no real telemetry source for this dataset). |
